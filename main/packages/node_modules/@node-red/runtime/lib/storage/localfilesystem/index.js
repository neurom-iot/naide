            ...
            try {
                ...
                try {
                    ...
                    if (process.env.HOMEPATH) {
                        fs.statSync(fspath.join(process.env.HOMEPATH,".naide",".config.json"));
                        settings.userDir = fspath.join(process.env.HOMEPATH,".naide");
                    }
                } catch(err) {
                }
                if (!settings.userDir) {
                    settings.userDir = fspath.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH || process.env.NODE_RED_HOME,".naide");
