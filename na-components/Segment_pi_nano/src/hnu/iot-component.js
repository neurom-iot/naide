module.exports = function(RED) {
    function Segment_pi_nano(config) {
...
//rspi && jetson nano && panda
            ...
            const pythonProcess = spawn('python3',["na-components/Segment_pi_nano/src/hnu/iot-component.py",data]);
    ...
    RED.nodes.registerType("Segment_pi_nano",Segment_pi_nano);
}
