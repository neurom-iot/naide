...
//rspi && jetson nano && panda
            ...
            const pythonProcess = spawn('python',["na-components/Segment_panda/src/hnu/iot-component.py",data]);
    ...
    RED.nodes.registerType("Segment_panda",Segment_panda);
}
