...
//rspi && jetson nano && panda
            ...
            const pythonProcess = spawn('python',["na-components/Segment-panda/src/hnu/iot-component.py",data]);
    ...
    RED.nodes.registerType("Segment-panda",Segment-panda);
}
