...
//rspi && jetson nano && panda
            ...
            const pythonProcess = spawn('python',["na-components/LED_panda/src/hnu/iot-component.py",data]);
    ...
    RED.nodes.registerType("LED_panda",LED_panda);
}
