module.exports = function(RED) {
    function Segment-pi_nano(config) {
...
//rspi && jetson nano && panda
            ...
            const pythonProcess = spawn('python3',["na-components/Segment-pi_nano/src/hnu/iot-component.py",data]);
    ...
    RED.nodes.registerType("Segment-pi_nano",Segment-pi_nano);
}
