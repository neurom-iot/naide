...
//rspi && jetson nano && panda
            ...
            const pythonProcess = spawn('python3',["na-components/LED-pi_nano/src/hnu/iot-component.py",data]);
    ...
    RED.nodes.registerType("LED-pi_nano",LED-pi_nano);
}
