module.exports = function(RED) {
    function NeromorphicBoard(config) {
...
//rspi && jetson nano && panda
            ...
            const pythonProcess = spawn('python',["na-components/nengo-fpga/NeromorphicBoard/src/hnu/snn-component.py",data]);
    ...
    RED.nodes.registerType("NeromorphicBoard",NeromorphicBoard);
}
