module.exports = function(RED) {
    function NeuromorphicBoard(config) {
...
//rspi && jetson nano && panda
            ...
            const pythonProcess = spawn('python',["na-components/nengo-fpga/NeuromorphicBoard/src/hnu/snn-component.py",data]);
    ...
    RED.nodes.registerType("NeuromorphicBoard",NeuromorphicBoard);
}
